package CaracteristicasDaLiguagemII.strings;
...
public class Strings {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Com Trim [" + string.trim() + "]");//Tirar o expaço em branco da String
    ...
    System.out.println("Replace " + string.replace("n", "$"));//Trocar caracter
    ...
    System.out.println("Substring(1,6)=" + string.substring(1, 6));//pega o texto dentro da posição determinada
